...
export declare const SWAP_ROUTER_02_ADDRESSES: (chainId: number) => "0xB971eF87ede563556b2ED4b1C0b0019111Dd85d2" | "0x5ce9188dBb7B0D10BfB35E224d431eC6527BA93E" | "0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45";
...
export declare const WETH9: {
    [chainId in Exclude<ChainId, ChainId.POLYGON | ChainId.POLYGON_MUMBAI | ChainId.CELO | ChainId.CELO_ALFAJORES | ChainId.GNOSIS | ChainId.MOONBEAM | ChainId.BSC | ChainId.MOONBASE_ALPHA>]: Token;
};
